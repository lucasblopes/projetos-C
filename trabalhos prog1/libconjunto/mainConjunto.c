...
int main(){
    //conjunto uniao pode ter ate 2*MAX elementos
    int conjuntoA[100], conjuntoB[100], conjuntoAleatorio[100], conjuntoUniao[200], conjuntoInter[100], cmd;
    int *conjuntoEscolhido, *conjunto1, *conjunto2;

    preencherMenosUm(conjuntoA);
    preencherMenosUm(conjuntoB);
    preencherMenosUm(conjuntoAleatorio);
    preencherMenosUm(conjuntoUniao);
    preencherMenosUm(conjuntoInter);
    ...
    do {
        ...
        case 7:
            ...
            if(tamanho(conjunto1) < tamanho(conjunto2))
